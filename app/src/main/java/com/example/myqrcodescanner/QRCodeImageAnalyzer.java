...
public class QRCodeImageAnalyzer implements ImageAnalysis.Analyzer {
    private QRCodeFoundListener qrCodeFoundListener;
    public QRCodeImageAnalyzer(QRCodeFoundListener qrCodeFoundListener) {
        this.qrCodeFoundListener = qrCodeFoundListener;
    }
    ...
    public void analyze(@NonNull ImageProxy image) {
        if (image.getFormat() == YUV_420_888 || image.getFormat() == YUV_422_888 || image.getFormat() == YUV_444_888) {
            ...
            try {
                ...
                this.qrCodeFoundListener.onQRCodeFound(result.getText());
            } catch (FormatException | ChecksumException | NotFoundException e) {
                this.qrCodeFoundListener.qrCodeNotFound();
            }
        }
